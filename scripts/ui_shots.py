"""Capture Flutter web screenshots at several viewports.
...
looks right. This grabs real pixels so the result can be inspected.
    ...
    python scripts/ui_shots.py http://127.0.0.1:8085 out_dir
"""
import base64
import json
import os
...
def main():
    ...
    proc = subprocess.Popen(
        [
            ...
            "--hide-scrollbars",
            "--no-first-run",
            "--user-data-dir=" + os.path.expandvars(r"%TEMP%\cdp_ui_shots"),
            "about:blank",
        ],
