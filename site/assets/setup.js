...
(function () {
  ...
  var PLATFORMS = {
    android: {
      ...
      primaryUrl: '/assets/MosaicVPN-Android-v0.3.63.apk',
      secondaryName: 'Зеркало GitHub',
      secondaryUrl: 'https://github.com/DangerousANEN/mosaicvpn/releases/download/v0.3.63/MosaicVPN-Android-v0.3.63.apk',
      note: 'Версия v0.3.63 · Android 7.0+ · ARM64/ARM32',
      isAvailable: true,
    },
    windows: {
      title: 'Windows',
      ...
      primaryUrl: 'https://github.com/DangerousANEN/mosaicvpn/releases/download/v0.3.63/MosaicVPN-Setup-x64-v0.3.63.exe',
      secondaryName: 'Portable .zip (36.8 МБ)',
      secondaryUrl: 'https://github.com/DangerousANEN/mosaicvpn/releases/download/v0.3.63/MosaicVPN-Portable-x64-v0.3.63.zip',
      note: 'Версия v0.3.63 · Windows 10/11 x64',
      isAvailable: true,
    },
    linux: {
      title: 'Linux',
      ...
      primaryUrl: 'https://github.com/DangerousANEN/mosaicvpn/releases/download/v0.3.63/MosaicVPN_0.3.63_amd64.deb',
      secondaryName: 'Portable .tar.gz (41.5 МБ)',
      secondaryUrl: 'https://github.com/DangerousANEN/mosaicvpn/releases/download/v0.3.63/MosaicVPN-Portable-x86_64-v0.3.63.tar.gz',
      note: 'Версия v0.3.63 · glibc 2.31+ x86_64',
      isAvailable: true,
    },
    apple: {
      title: 'iOS & macOS',
